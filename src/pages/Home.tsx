...
import { Star, Users, ArrowRight, ShoppingBag, Globe, Zap, Shield, Box, Settings, BarChart } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Built-in payment processing with top-tier security and fraud prevention.'
    },
    {
      icon: <Box className="w-8 h-8" />,
      title: 'Inventory Management',
      description: 'Powerful tools to manage your products, stock levels, and orders efficiently.'
    },
    {
      icon: <Settings className="w-8 h-8" />,
      title: 'Customizable',
      description: 'Fully customizable storefront with professional themes and custom CSS support.'
    },
    {
      icon: <BarChart className="w-8 h-8" />,
      title: 'Analytics',
      description: 'Detailed insights and reports to help you grow your business.'
    },
    {
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-32 text-center">
        ...
        <div className="text-center mb-16 space-y-8">
          <h1 className="text-6xl lg:text-8xl font-bold leading-tight text-slate-950">
            ...
            <span className="block mt-2 text-slate-800">Our Platform</span>
          </h1>

          <p className="text-lg text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Create a stunning online store, showcase your products, and reach customers worldwide.
            Join thousands of successful sellers on our premium platform.
          </p>
        </div>
